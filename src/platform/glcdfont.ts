// Adafruit GFX "classic" 5x7 bitmap font (glcdfont), BSD-licensed.
...
// in that row. Rendered in a 6x8 cell (5px glyph + 1px right spacing).
// Used by CanvasDisplay to reproduce on-device text exactly. Do not hand-edit.

export const GLYPH_COLS = 5;
export const GLYPH_ROWS = 8;
export const FONT_5X7: Uint8Array = new Uint8Array([
